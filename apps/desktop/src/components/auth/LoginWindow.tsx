...
export function LoginWindow({ ready = true }: { ready?: boolean }) {
  ...
  return (
    <main className="mole-native-login relative h-screen overflow-y-auto overflow-x-clip text-slate-950 dark:text-slate-100">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_24%_18%,rgba(140,63,252,0.18),transparent_34%),radial-gradient(circle_at_84%_12%,rgba(253,45,134,0.10),transparent_30%),radial-gradient(circle_at_70%_92%,rgba(41,115,253,0.10),transparent_38%),linear-gradient(135deg,rgba(255,255,255,0.5),rgba(246,242,255,0.55))] dark:bg-[radial-gradient(circle_at_24%_18%,rgba(140,63,252,0.22),transparent_34%),radial-gradient(circle_at_84%_12%,rgba(253,45,134,0.12),transparent_30%),radial-gradient(circle_at_70%_92%,rgba(41,115,253,0.14),transparent_38%)]" />
      <div className="pointer-events-none absolute left-[12%] top-[15%] h-72 w-72 rounded-full bg-violet-200/30 blur-3xl dark:bg-violet-500/15" />
      <div className="pointer-events-none absolute right-[14%] top-[10%] h-64 w-64 rounded-full bg-pink-100/40 blur-3xl dark:bg-pink-500/10" />
            ...
            <AnimatePresence>
              {!showForm && (
                <motion.span
                  key="loader-ring"
                  aria-hidden="true"
                  className="absolute inset-0 animate-spin rounded-full border-4 border-violet-200/55 border-t-violet-600 dark:border-violet-500/20 dark:border-t-violet-400"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
