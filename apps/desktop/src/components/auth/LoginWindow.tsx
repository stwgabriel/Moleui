...
function LoginLoadingState() {
  return (
    <main className="relative flex h-screen items-center justify-center overflow-hidden text-slate-950">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_28%_18%,rgba(140,63,252,0.18),transparent_34%),radial-gradient(circle_at_88%_16%,rgba(253,45,134,0.10),transparent_30%),linear-gradient(135deg,rgba(255,255,255,0.5),rgba(246,242,255,0.55))]" />
